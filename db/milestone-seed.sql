...
VALUES
  ('ba-ms-01', 'p-mock-026', 'c-mock-04', 'u-mock-19', 'u-mock-11', 'bd-008', 22500, 1775779201);
...
INSERT OR IGNORE INTO post_badge_applications
  (id, post_id, community_id, giver_user_id, recipient_user_id, badge_definition_id, coin_amount, created_at)
VALUES
  ('ba-ms-02', 'p-mock-019', 'c-mock-03', 'u-mock-17', 'u-mock-09', 'bd-008', 95000, 1775779202);
...
INSERT OR IGNORE INTO post_badge_applications
  (id, post_id, community_id, giver_user_id, recipient_user_id, badge_definition_id, coin_amount, created_at)
VALUES
  ('ba-ms-03', 'p-mock-007', 'c-mock-01', 'u-mock-19', 'u-mock-02', 'bd-008', 499500, 1775779203);
